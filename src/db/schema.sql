...
-- =====================================================
-- VEHICLES (FIXED: added serial)
-- =====================================================
CREATE TABLE IF NOT EXISTS vehicles (
  id SERIAL PRIMARY KEY,
  serial VARCHAR(100) UNIQUE,                 -- 🔥 REQUIRED BY MARIA SYNC
...
-- =====================================================
-- DEVICES (FIXED: added serial + positionid)
-- =====================================================
CREATE TABLE IF NOT EXISTS devices (
  id SERIAL PRIMARY KEY,
  device_uid VARCHAR(100) NOT NULL UNIQUE,
  serial VARCHAR(100),                        -- 🔥 REQUIRED BY MARIA SYNC
  positionid BIGINT DEFAULT 0,               -- 🔥 TRACK LAST EVENT ID
  label VARCHAR(150),
